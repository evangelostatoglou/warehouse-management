...
{
    /// <inheritdoc />
    public partial class AddWarehouseManagementSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Inventory_QuantityOnHand_NonNegative", "\"QuantityOnHand\" >= 0");
                    table.CheckConstraint("CK_Inventory_QuantityReserved_NonNegative", "\"QuantityReserved\" >= 0");
                    table.CheckConstraint("CK_Inventory_QuantityReserved_WithinOnHand", "\"QuantityReserved\" <= \"QuantityOnHand\"");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Orders_Status_Allowed", "\"Status\" IN ('DRAFT', 'CONFIRMED', 'PICKING', 'SHIPPED', 'CANCELLED')");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_PurchaseOrders_Status_Allowed", "\"Status\" IN ('DRAFT', 'ORDERED', 'PARTIALLY_RECEIVED', 'RECEIVED', 'CANCELLED')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_StockMovements_Type_Allowed", "\"Type\" IN ('PURCHASE', 'SALE', 'RETURN', 'TRANSFER_IN', 'TRANSFER_OUT', 'ADJUSTMENT')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_PurchaseOrderItems_Quantity_Positive", "\"Quantity\" > 0");
